...
#    def __copy__(self):
#        '''
#        we want to shallow copy but copy the numpy arrays too 
#        '''
#        printl("custom copy")
#        cls = self.__class__
...
#                result.__dict__[key] = numpy.copy(self.__dict__[key])
#        return result
    ...
    def getNNdist(self,ncheck=1):        
        ...
        printl("pointSet NN dist",math.sqrt(numpy.average(avr2)))    
        return math.sqrt(numpy.average(avr2))

    def initArrays(self,npoints):
