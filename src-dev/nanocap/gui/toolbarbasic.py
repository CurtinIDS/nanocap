...
#
    ...
    def GenerateStructure(self):
        ...
        if(self.CarbonMinimiseCombo.currentText()=="Topology Only"):
    ...
    def setup_general_widgets(self):
        ...
        self.NMinima = SpinBox()
        self.NMinima.setValue(self.config.opts["NMinima"])
        self.NMinima.setFixedWidth(50)
        self.connect(self.NMinima, QtCore.SIGNAL('valueChanged(int)'), self.setNMinima)
        row.addWidget(lb,2,0,alignment=QtCore.Qt.AlignRight)
        row.addWidget(self.NMinima,2,1,alignment=QtCore.Qt.AlignLeft)
        
        
        self.CarbonMinimiseCombo= QtGui.QComboBox()
        self.CarbonMinimiseCombo.addItem("Topology Only")
...
#        self.CalcRenTable.setColumnCount(5)
#        self.CalcRenTable.setHorizontalHeaderLabels(("Option","Show","Label","Rad","Col"))
#        #self.MinimaTable.setMinimumHeight(200)
#        
#        #self.MinimaTable.setRowHeight(30)
#        #self.MinimaTable.setColumnWidth(0,40)
#        self.CalcRenTable.setColumnWidth(0,100)
#        self.CalcRenTable.setColumnWidth(1,40)
#        self.CalcRenTable.setColumnWidth(2,40)
#        self.CalcRenTable.setColumnWidth(3,80)
#        self.CalcRenTable.setColumnWidth(4,50)
