...
#    if pyqt_flag:
#        import QtGui.QWidget as MSWidget
#    else:
#        from QtGui import QWidget as MSWidget
#else:
#    if pyqt_flag:
#        from QtOpenGL import QGLWidget as MSWidget
#    else:
#        from QtOpenGL import QGLWidget as MSWidget

MSWidget = QtOpenGL.QGLWidget
