...
class toolbar(QtGui.QWidget):   
    ...
    def setCarbonForceField(self,val):
        ...
        if(self.CarbonMinimiseCombo.currentText()=="Scaled Topology"):
            self.config.opts["CarbonForceField"]="Scaled Topology"  
    ...
    def MinimiseCarbonAtoms(self):
        ...
        self.ThreadManager.submit_to_queue(self.Processor.updateCarbonLattice)
    ...
    def setNStructures(self,val):
        self.config.opts["NStructures"]=val
        
    def setNMaxStructures(self,val):
        self.config.opts["NMaxStructures"]=val    
